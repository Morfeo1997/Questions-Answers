...
function CinemaChallenge() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-red-500 via-rose-600 to-rose-800 flex flex-col items-center p-4 pt-8">
      ...
      <div className='min-w-screen flex justify-center'>
        <button
          onClick={() => navigate("/")}
          className="mt-6 cursor-pointer px-16 py-3 bg-white text-red-600 text-xl font-bold rounded-xl shadow-lg hover:bg-red-200 hover:text-rose-900 transition duration-300"
        >
          Volver
        </button>
      </div>
...
export default CinemaChallenge;