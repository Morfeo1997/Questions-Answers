...
import Challenge from '../Data/NutritionData.json';
import QuestionCard from '../components/QuestionCard.jsx';
import ProgressBar from '../components/ProgressBar.jsx';
import GameSummary from '../components/GameSummary.jsx';

function NutritionChallenge() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-lime-500 via-green-600 to-emerald-800 flex flex-col items-center p-4 pt-8">
      ...
      <div className='min-w-screen flex justify-center'>
        <button
          onClick={() => navigate("/")}
          className="mt-6 cursor-pointer px-16 py-3 bg-white text-lime-600 text-xl font-bold rounded-xl shadow-lg hover:bg-lime-200 hover:text-shadow-lime-700 transition duration-300"
        >
          Volver
        </button>
      </div>
