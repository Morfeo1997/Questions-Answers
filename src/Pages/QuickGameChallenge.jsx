...
import Challenge from '../Data/QuickGameData.json';
...
function NutritionChallenge() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-500 via-cyan-600 to-blue-800 flex flex-col items-center p-4 pt-8">
      ...
      <div className='min-w-screen flex justify-center'>
        <button
          onClick={() => navigate("/")}
          className="mt-6 cursor-pointer px-16 py-3 bg-white text-blue-600 text-xl font-bold rounded-xl shadow-lg hover:bg-blue-200 hover:text-shadow-blue-700 transition duration-300"
        >
          Volver
        </button>
      </div>
