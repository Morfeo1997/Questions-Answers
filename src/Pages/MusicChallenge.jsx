...
function MusicChallenge() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-yellow-500 via-amber-600 to-amber-800 flex flex-col items-center p-4 pt-8">
      ...
      <div className='min-w-screen flex justify-center'>
        <button
          onClick={() => navigate("/")}
          className="mt-6 cursor-pointer px-16 py-3 bg-white text-yellow-600 text-xl font-bold rounded-xl shadow-lg hover:bg-yellow-200 hover:text-shadow-yellow-700 transition duration-300"
        >
          Volver
        </button>
      </div>
